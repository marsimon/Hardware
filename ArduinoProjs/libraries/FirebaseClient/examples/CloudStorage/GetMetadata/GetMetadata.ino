...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cstorage.getMetadata(aClient, GoogleCloudStorage::Parent(STORAGE_BUCKET_ID, "media.mp4"), options, asyncCB);

        // To assign UID for async result
        // cstorage.getMetadata(aClient, GoogleCloudStorage::Parent(STORAGE_BUCKET_ID, "media.mp4"), options, asyncCB, "myUID");
