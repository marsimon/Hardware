 ...
 * SYNTAX:
 *
 * Storage::deleteObject(<AsyncClient>, <FirebaseStorage::Parent>);
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        storage.deleteObject(aClient, FirebaseStorage::Parent(STORAGE_BUCKET_ID, "media.mp4"), asyncCB);

        // To assign UID for async result
        // storage.deleteObject(aClient, FirebaseStorage::Parent(STORAGE_BUCKET_ID, "media.mp4"), asyncCB, "myUID");
